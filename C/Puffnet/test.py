...
# model load
state_dict = torch.load('model/base_iter_12000.pth')
...
state_dict = torch.load('model/decoder_iter_100000.pth')
new_state_dict = OrderedDict()
for k, v in state_dict.items():
    namekey = k
    new_state_dict[namekey] = v
...
state_dict = torch.load('model/detail_iter_100000.pth')
new_state_dict = OrderedDict()
for k, v in state_dict.items():
    namekey = k
    new_state_dict[namekey] = v
...
state_dict = torch.load('model/embedding_iter_100000.pth')
new_state_dict = OrderedDict()
for k, v in state_dict.items():
    namekey = k
    new_state_dict[namekey] = v
...
state_dict = torch.load('model/transformer_iter_100000.pth')
new_state_dict = OrderedDict()
for k, v in state_dict.items():
    namekey = k
    new_state_dict[namekey] = v
